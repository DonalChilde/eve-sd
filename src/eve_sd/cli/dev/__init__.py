...
from eve_sd.cli.dev.compare import app as compare_app
from eve_sd.cli.dev.db_perf import app as db_perf_app
from eve_sd.cli.dev.generate_test_data import app as generate_test_data_app
