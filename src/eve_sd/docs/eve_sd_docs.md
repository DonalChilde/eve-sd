<!-- This is the version of the EVE SD docs that is available from the CLI. -->

# EVE SD Documentation

## What This App Does

eve-sd provides a command-line workflow and Python API for working with
